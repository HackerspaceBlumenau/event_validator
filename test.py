...
e                       received_events",
    ...
    def test_is_first_section_line(self):
        self.assertTrue(action.is_first_section_line("Descrição: Evento \
                muito maneiro de python!"))
        self.assertTrue(action.is_first_section_line("Nome: Python Brasil"))
        self.assertTrue(action.is_first_section_line("Data sugerida: \
                26/10/2019"))
        self.assertTrue(action.is_first_section_line("e-mail: \
                fulaninho@hs.com"))

        self.assertFalse(action.is_first_section_line("email: \
            fulaninho@hs.com"))
        self.assertFalse(action.is_first_section_line("Descricao: Evento \
                muito maneiro de python!"))
    ...
    def test_has_all_required_data(self):
        self.assertTrue(action.has_all_required_data(self.event))

    def test_get_sections(self):
        sections = action.get_sections(self.issue["body"])
        self.assertEqual(len(sections), 4)
        self.assertIn("Descrição", sections, msg="Missing 'descrição'")
        self.assertEqual(sections["Descrição"],
                         "Evento muito maneiro de python!")
        self.assertIn("Nome", sections, msg="Missing 'Nome'")
        self.assertEqual(sections["Nome"], "Fulaninho")
        self.assertIn("e-mail", sections, msg="Missing 'e-mail'")
        self.assertEqual(sections["e-mail"], "fulaninho@hs.com")
